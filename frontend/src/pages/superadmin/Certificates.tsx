    ...
    return new Promise((resolve, reject) => {
      ...
      iframe.addEventListener('load', async () => {
        try {
          ...
          // Wait for fonts and images inside the iframe to fully load and paint
          if (doc?.fonts) {
            try {
              await doc.fonts.load('700 54px "Cinzel"');
              await doc.fonts.load('700 34px "Cinzel"');
              await doc.fonts.load('700 16px "Cinzel"');
              await doc.fonts.load('700 15px "Montserrat"');
              await doc.fonts.load('500 22px "Montserrat"');
              await doc.fonts.load('400 15px "Montserrat"');
              await doc.fonts.load('300 13px "Montserrat"');
              await doc.fonts.load('600 14px "Montserrat"');
              await doc.fonts.load('300 13px "Montserrat"');
              await doc.fonts.load('400 14px "Montserrat"');
              await doc.fonts.load('400 15px "Montserrat"');
              await doc.fonts.load('600 13px "Montserrat"');
              await doc.fonts.load('700 15px "Montserrat"');
              await doc.fonts.load('400 16px "Montserrat"');
              await doc.fonts.load('700 16px "Montserrat"');
            } catch (e) {
...
<div class="page">
  ...
  // ── Branch Certificate HTML (matches Figma design) ─────────────────────────
  const branchCertificateHtml = (branch: any) => {
    const o = window.location.origin;
...
<div class="page">
  ...
  <img
    class="bg"
    src="${o}/certificate-assets/branch/bg.png"
    alt=""
  >

  <img
    class="ornaments"
    src="${o}/certificate-assets/branch/ornaments.svg"
    alt=""
  >

  <div class="main-title">
    DNYANSETU EDUCATION &amp; IT<br>
    INSTITUTION INDIA
  </div>

  <div class="affil">
    (Affliated by Ministry of Corporate Affairs Government of India<br>
    CIN.U85490PN2026PTC252150)
  </div>
  ...
  <div class="branch">
    Authorised Training Provider DNYANSETU INSTITUTE ,${branchLocation.toUpperCase()}
  </div>
  ...
  <div class="logos">
    ...
    <img
      class="logo-iso"
      src="${o}/certificate-assets/branch/iso.svg"
      alt="ISO"
    >

    <img
      class="logo-msme"
      src="${o}/certificate-assets/branch/msme.svg"
      alt="MSME"
    >

    <img
      class="logo-startup"
      src="${o}/certificate-assets/branch/startup-india.svg"
      alt="Startup India"
    >
  ...
  <div class="bottom-left">
    ...
    <img
      class="brand-logo"
      src="${o}/certificate-assets/branch/logo.svg"
      alt="DnyanSetu"
    >

    <div class="address">
      DnyanSetu Institute, 2nd floor, Kapare Heights, near hadapsar<br>
      bhaji mandai, Hadapsar, Pune - 28
    </div>
